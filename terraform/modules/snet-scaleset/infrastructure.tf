...
#//Start of public ip to be removed after development phase//////////////////////////////
resource "azurerm_public_ip_prefix" "pubip_prefix" {
    name                = "ip-prefix-vmss"
    #Make the region a variable so that you can deploy this to multiple regions.
    location            = "West US"
    resource_group_name = data.azurerm_resource_group.pipeline-resources.name
    prefix_length = 29
}
#//End of public ip to be removed after development phase
